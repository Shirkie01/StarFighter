...
namespace Prototype.NetworkLobby
{
    ...
    public class LobbyPlayer : NetworkLobbyPlayer
    {
        private static Color[] Colors = new Color[] {
            // dull orange
            new Color(153 / 255f, 102 / 255f, 0),
            // blue
            new Color(50 / 255f, 50 / 255f, 1),
            // red
            new Color(1, 50 / 255f, 50 / 255f),
            // green
            new Color(0, 150 / 255f, 0),
            // cyan
            new Color(50 / 255f, 235 / 255f, 1),
            //
            new Color(223 / 255f, 52 / 255f, 0),
            // yellow
            new Color(1, 1, 0),
            // yellowish
            new Color(1, 102 / 255f, 0),
            //
            new Color(128 / 255f, 0, 64 / 255f), new Color(50 / 255f, 1, 50 / 255f), new Color(179 / 255f, 251 / 255f, 186 / 255f), new Color(80 / 255f, 80 / 255f, 80 / 255f), new Color(1, 0, 102 / 255f) };
            ...
            do
            {
                ...
                for (int i = 0; i < _colorInUse.Count; ++i)
                {
                    ...
                    {//that color is already in use
                        Debug.Log("Color " + idx + " already in use");
                        alreadyInUse = true;
                        idx = (idx + 1) % Colors.Length;
                    }
                }
